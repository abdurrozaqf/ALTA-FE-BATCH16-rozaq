...
const RegisterAccount = () => {
  ...
  return (
    <div className="w-full h-screen flex items-center font-inter overflow-auto bg-gradient-to-br from-indigo-300 to-indigo-100 dark:from-indigo-950 dark:to-indigo-900/20">
      <div className="container w-full md:w-[34.75rem] h-fit p-6 md:p-8 lg:py-10 lg:px-14 flex flex-col items-center bg-white dark:bg-black/25 dark:border rounded-md shadow-xl">
        <img
